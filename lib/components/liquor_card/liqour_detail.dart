...
class LiqourDetail extends StatefulWidget {
  final String? category;
  const LiqourDetail({super.key, this.category});

  @override
  State<LiqourDetail> createState() => _LiqourDetailState();
}

class _LiqourDetailState extends State<LiqourDetail> {
  bool isLoading = true;
  ...
  Future<void> fetchLiquors() async {
    try {
      ...
      final lqData = await LiquorService()
          .getLiquorsByCategoryAndUserWithDetails(widget.category ?? '', user.uid);
